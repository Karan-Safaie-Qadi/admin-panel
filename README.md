...
- Python 3 یا Node.js (برای سرور محلی)
...
سپس در مرورگر خود آدرس `http://localhost:8000` (یا پورت نمایش داده شده) را باز کنید.

> **نکته:** نیازی به build نیست. این پروژه HTML/CSS/JS خالص است.

---

## 📖 راهنما

از سایدبار برای دسترسی به بخش‌های مختلف استفاده کنید:

| صفحه | توضیحات |
|------|---------|
| **داشبورد** | نمای کلی با آمار، نمودار و سفارشات اخیر |
| **محصولات** | مدیریت کاتالوگ محصولات (افزودن/ویرایش/حذف) |
| **دسته‌بندی‌ها** | سازماندهی محصولات در دسته‌ها |
...
<p align="center">ساخته شده با ❤️ برای رزومه</p>
